...
describe('AuszahlungKontenComponent(FT/CE)', () => {
  let component: AuszahlungKontenComponent;
  let fixture: ComponentFixture<AuszahlungKontenComponent>;
  let auszahlungKontenServiceMock: jasmine.SpyObj<AuszahlungKontenService> = jasmine.createSpyObj('AuszahlungKontenService', ['save']);
  beforeEach(async(() => {
